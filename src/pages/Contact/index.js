...
function Contact() {
  return (
    <div className="hero is-fullheight">
      ...
      <section className="hero-body is-brand-grey" style={{alignItems: "stretch"}}>
          ...
          <form id="contactForm">
            ...
            <div className="field">
              <label
                ...
                className="label is-font-light-grey"
              >
                Message
              </label>
              <p className="control">
            ...
            <div className="field">
              <div className="control">
                <button
                  className="button is-brand-dark-grey is-font-light-grey"
                  type="submit"
                >
                  Send Email
                </button>
